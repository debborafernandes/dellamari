...
class ComentariosControllerTest < ActionController::TestCase
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post :create, comentario: { assunto: @comentario.assunto, autor: @comentario.autor, comentario: @comentario.comentario }
    end
  ...
  test "should update comentario" do
    put :update, id: @comentario, comentario: { assunto: @comentario.assunto, autor: @comentario.autor, comentario: @comentario.comentario }
    assert_redirected_to comentario_path(assigns(:comentario))
  end
